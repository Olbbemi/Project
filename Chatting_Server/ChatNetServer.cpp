...
/**----------------------------------------------------------------------------
  * 일정주기마다 세션을 관리하는 자료구조를 확인하기 위해 Update 쓰레드로 메시지 전달
  * 해당 함수가 직접 처리하는 것이 아닌 처리를 요청하는 메시지만 전달하는 역할
  *----------------------------------------------------------------------------*/
...
/**---------------------------------------------------------------------------------------------------
  ...
  * 현 구조에서는 패킷 처리만하므로 서버쪽에서 패킷을 보내면 SetEvent 함수를 통해 해당 Update 쓰레드를 깨움
...
/**-----------------------------------------------------------------------------------------
  * 세션을 관리하는 자료구조내 각 세션키의 유효시간을 확인하여 이미 해당 유효시간을 넘었다면 삭제
  *-----------------------------------------------------------------------------------------*/
...
/**---------------------------------------------------------------
  * 서버가 종료될 때 컨텐츠의 Update 및 GC 쓰레드 종료를 위해 호출하는 함수
  *---------------------------------------------------------------*/
