...
include_once $_SERVER['DOCUMENT_ROOT']."/ASSOC_LIB/File_Log_Lib.php";
//include_once $_SERVER['DOCUMENT_ROOT']."/ASSOC_LIB/ERROR_Handler.php";

include_once $_SERVER['DOCUMENT_ROOT']."/ASSOC_DB/DB_Config_Log.php";
include_once $_SERVER['DOCUMENT_ROOT']."/ASSOC_DB/DB_Control.php";

$g_log_DB_game_handle;
...
$check = DB_Connection($g_log_DB_game_handle, $g_log_DB_ip, $g_log_DB_id, $g_log_DB_pass, $g_log_DB_name, $g_log_DB_port);
if($check === false)
{
    $lo_error_log = "DB_Connection Error\r\n";
    $lo_error_log .= "DB_ip = {$g_log_DB_ip}\r\n";
    $lo_error_log .= "DB_id = {$g_log_DB_id}\r\n";
    $lo_error_log .= "DB_pass = {$g_log_DB_pass}\r\n";
    $lo_error_log .= "DB_name = {$g_log_DB_name}\r\n";
    $lo_error_log .= "DB_port = {$g_log_DB_port}\r\n";

    File_Log(__FLIE__, __LINE__, $lo_error_log);
    exit;
}

mysqli_set_charset($g_log_DB_game_handle, "utf8");
...
$Result = DB_TransactionQuery($g_log_DB_game_handle, $Trans_Query, $recent_AI_id, $errno);
if ($Result === false)
{
