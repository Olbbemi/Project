...
void C_NetServer::M_NetS_Initialize(ST_NET_SERVER& pa_parse_data)
{
	...
	m_tls_DB_connector = new C_DBConnectTLS(pa_parse_data.parse_make_work, pa_parse_data.parse_DB_ip, pa_parse_data.parse_DB_user, pa_parse_data.parse_DB_password, pa_parse_data.parse_DB_name, pa_parse_data.parse_DB_port);
