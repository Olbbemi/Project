...
#pragma pack(pop)
		...
		void M_Encode(C_Serialize* pa_serialQ);
		bool M_Decode(C_Serialize* pa_serialQ);

		bool M_SessionAcquireLock(LONG64 pa_session_id, WORD& pa_index);
		void M_SessionAcquireUnlock(LONG64 pa_session_id, WORD pa_index);
	...
	protected:
		...
		virtual void VIR_OnClientJoin(LONG64 pa_session_id) = 0;
